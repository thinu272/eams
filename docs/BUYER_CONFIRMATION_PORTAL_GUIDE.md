...
### Backend
- [Icon: Success] Update Ticket model status enum
- [Icon: Success] Add allAssigned field to Order model
- [Icon: Success] Create tickets.js route with POST /api/tickets/assign
- [Icon: Success] Create POST /api/tickets/invite in tickets.js
- [Icon: Success] Update orders.js to create tickets with PENDING status
- [Icon: Success] Update attendees.js to use new status values
- [Icon: Success] Add tickets route to server.js
