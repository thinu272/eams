...
This will tell you:
- [Icon: Success]/[Icon: Error] Is MongoDB connected?
- [Icon: Success]/[Icon: Error] Are there orders in the database?
- [Icon: Success]/[Icon: Error] What's the latest order token?
- [Icon: Success]/[Icon: Error] Are event details populated?
- [Icon: Success]/[Icon: Error] What are the ticket statuses?
...
router.get('/confirm/:token', async (req, res) => {
  console.log('[Icon: Search] GET /orders/confirm/:token');
